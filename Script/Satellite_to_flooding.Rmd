...
- for Sentinel 2 data, these are band 3 (green), 4 (red), 8 (NIR), 11 (SWIR 1) and 12 (SWIR 2) - note that the SWIR data are available at a 20m, rather than 10m resolution. Note that these data have different naming conventions, etc. than Landsat data. This script is set up for Landsat data, so modifications would have to be made to cater for Sentinel 2 data.
...
- DataType***
  ...
  - Check here that your data say SR (surface reflectance) not ST (surface temperature) - if ST, you may have accidentally downloaded the wrong data and should go back and download the surface reflectance data
  
As we import our data into lists, we are renaming the rasters to just retain the information we need. The new naming format is as follows:
SatelliteType_Location_Date_Band - e.g., L8_094084_20131125_B3

```{r Input data - rasters}
# Set your working directory to the folder containing the TIFF files. Here starts the directory in your R project folder, and then write the relative path to where your data are.
setwd(here("../../Raw Landsat data"))
...
file_list <- list.files(pattern = paste("^(LT05|LE07|LC08|LC09)_L2SP_\\d+_\\d+_\\d+_(02_)?T[1-2]_SR_B[2-7]\\.TIF", sep = ""))
print(file_list)
...
extract_info <- function(filename) {
  ...
  location <- parts[3]
  date <- parts[4]
  band <- gsub("SR_", "", parts[length(parts)]) #gsub means substitute one thing for another
  band <- gsub("\\.TIF", "", band)
...
writeRaster(wi_cumbung_2010,filename = here("Export/wi_cumbung_20101203.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2011,filename = here("Export/wi_cumbung_20111104.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2012,filename = here("Export/wi_cumbung_20121114.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2013,filename = here("Export/wi_cumbung_20131125.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2014,filename = here("Export/wi_cumbung_20141112.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2015,filename = here("Export/wi_cumbung_20151115.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2016,filename = here("Export/wi_cumbung_20161117.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2017,filename = here("Export/wi_cumbung_20171104.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2018,filename = here("Export/wi_cumbung_20181022.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2019,filename = here("Export/wi_cumbung_20191110.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2020,filename = here("Export/wi_cumbung_20201018.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2021,filename = here("Export/wi_cumbung_20211030.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2022,filename = here("Export/wi_cumbung_20221118.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2023,filename = here("Export/wi_cumbung_20231105.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_cumbung_2024,filename = here("Export/wi_cumbung_20241030.tif"), format="GTiff", overwrite = TRUE)
```

```{r Write water index rasters - booligal}
# write rasters

writeRaster(wi_bool_2010,filename = here("Export/wi_bool_20101008.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_bool_2011,filename = here("Export/wi_bool_20111011.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_bool_2012,filename = here("Export/wi_bool_20121022.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_bool_2013,filename = here("Export/wi_bool_20131118.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_bool_2014,filename = here("Export/wi_bool_20141121.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_bool_2015,filename = here("Export/wi_bool_20151023-1108.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_bool_2016,filename = here("Export/wi_bool_20161110.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_bool_2017,filename = here("Export/wi_bool_20171129.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_bool_2018,filename = here("Export/wi_bool_20181116.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_bool_2019,filename = here("Export/wi_bool_20191119.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_bool_2020,filename = here("Export/wi_bool_20201020.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_bool_2021,filename = here("Export/wi_bool_20211023.tif"), format="GTiff", overwrite = TRUE)
writeRaster(wi_bool_2022,filename = here("Export/wi_bool_20221010_2.tif"), format="GTiff", overwrite = TRUE)
```
