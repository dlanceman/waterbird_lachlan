...
setwd("C:/Users/z5204897/OneDrive - UNSW/Desktop/RA/Projects/2023 Lachlan waterbird and flood datasets compilation/Raw Landsat data")
...
# Now list just the file names we're interested in
...
cumbung <- st_read("C:/Users/z5204897/OneDrive - UNSW/Desktop/RA/Projects/2023 Lachlan waterbird and flood datasets compilation/Boundaries/Cumbung_ecological.shp")
booligal <- st_read("C:/Users/z5204897/OneDrive - UNSW/Desktop/RA/Projects/2023 Lachlan waterbird and flood datasets compilation/Boundaries/Booligal_ecological.shp")
```
...
for (date in cumbung_dates){
  # calculate the water index
  water_index_raster <- 1.7204+171*grouped_rasters_cumbung[[date]][["B2"]]+3*grouped_rasters_cumbung[[date]][["B3"]]-70*grouped_rasters_cumbung[[date]][["B4"]]-45*grouped_rasters_cumbung[[date]][["B5"]]-71*grouped_rasters_cumbung[[date]][["B7"]]
  # store the results in a new results list
  water_index_results[[date]] <- water_index_raster
}



1.7204+171*grouped_rasters_cumbung[["20111104"]][["B2"]]+3*grouped_rasters_cumbung[["20111104"]][["B3"]]-70*grouped_rasters_cumbung[["20111104"]][["B4"]]-45*grouped_rasters_cumbung[["20111104"]][["B5"]]-71*grouped_rasters_cumbung[["20111104"]][["B7"]]


# use the overlay function to do calculations using multiple rasters
water_index <- overlay(B2, B3, B4, B5, B7, fun = function(B2, B3, B4, B5, B7) {
